...
The function returns a negative value if the first value is less than the second, a positive value if the first value is greater than the second, 
...
function merge(arr1, arr2, comparator) {
    // Default comparator function for sorting numbers in ascending order
