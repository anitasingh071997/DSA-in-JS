...
Start by picking the second element in the 
array (we will assume the first element is the start of the "sorted" portion)
...
function insertionSort(arr, comparator){
      ...
      //   default comparator function for ascending numeric numbers
      ...
      for(let i = 1; i < arr.length; i++) {
          ...
          // compare the currentValue with elements in the sorted portion
